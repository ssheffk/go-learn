...
type Ball struct {
	Object
	dxdt int // x velocity per click
	dydt int // y velocity per click
}
...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	highScore := "High Score: " + fmt.Sprint(g.highScore)
	text.Draw(screen, highScore, basicfont.Face7x13, 10, 30, color.White)
}
